...
for i in range(0, l, 1):
    ...
    stitch, H, skip, end_skip, subs, prev, end_prev, end_sub = stitching(images[i], images[i+1], threshold=0.3, ind = ind,
...
cv2.imwrite("submosaic/mosaicofinale.jpg", result)
